...
void ui_set_ev_values(ChargerState charger_state) {
  ...
  M5.Display.setCursor(POS_X_EV_A * POS_DX, POS_Y_L1 * POS_DY);
  M5.Display.printf("%4.1f", charger_state.c[0]);
  M5.Display.setCursor(POS_X_EV_V * POS_DX, POS_Y_L1 * POS_DY);
  M5.Display.printf("%3.0f", charger_state.v[0]);

  M5.Display.setCursor(POS_X_EV_A * POS_DX, POS_Y_L2 * POS_DY);
  M5.Display.printf("%4.1f", charger_state.c[1]);
  M5.Display.setCursor(POS_X_EV_V * POS_DX, POS_Y_L2 * POS_DY);
  M5.Display.printf("%3.0f", charger_state.v[1]);

  M5.Display.setCursor(POS_X_EV_A * POS_DX, POS_Y_L3 * POS_DY);
  M5.Display.printf("%4.1f", charger_state.c[2]);
  M5.Display.setCursor(POS_X_EV_V * POS_DX, POS_Y_L3 * POS_DY);
  M5.Display.printf("%3.0f", charger_state.v[2]);
}

void ui_set_home_values(double home_current[3]) {

  M5.Display.setCursor(POS_X_HOME_A * POS_DX, POS_Y_L1 * POS_DY);
  M5.Display.printf("%4.1f", home_current[0]);

  M5.Display.setCursor(POS_X_HOME_A * POS_DX, POS_Y_L2 * POS_DY);
  M5.Display.printf("%4.1f", home_current[1]);

  M5.Display.setCursor(POS_X_HOME_A * POS_DX, POS_Y_L3 * POS_DY);
